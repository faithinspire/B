...
write("app/(customer)/messages/[booking_id]/page.tsx", customerChat);
write("app/(braider)/braider/messages/[booking_id]/page.tsx", braiderChat);

console.log('\nAll chat pages written successfully!');
