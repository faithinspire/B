-- ============================================================================
-- COMPLETE BYPASS FIX FOR MARKETPLACE PRODUCTS & PASSWORD RESET EMAILS
-- ============================================================================
...
-- Step 1: Create password_reset_tokens table if it doesn't exist
...
-- Step 2: Disable RLS on password_reset_tokens
...
-- Step 4: Create email_logs table for tracking email delivery
...
-- Step 5: Disable RLS on email_logs
ALTER TABLE email_logs DISABLE ROW LEVEL SECURITY;

-- Step 6: Create index on email_logs
...
-- Step 7: Create email_templates table for password reset
...
-- Step 8: Disable RLS on email_templates
ALTER TABLE email_templates DISABLE ROW LEVEL SECURITY;

-- Step 9: Insert password reset email template
...
-- Step 10: Create function to generate password reset tokens
...
-- Step 11: Create function to verify password reset token
...
-- Step 12: Create function to delete password reset token after use
...
-- ✅ Created password_reset_tokens table → Reset tokens now stored
...
-- ============================================================================
-- 1. Update your password reset API endpoint to:
--    - Call generate_password_reset_token() to create tokens
--    - Send email via Resend with the reset link
--    - Log email delivery in email_logs table
--
-- 2. Update your password reset verification to:
--    - Call verify_password_reset_token() to validate tokens
--    - Call mark_password_reset_token_used() after successful reset
--
-- 3. Ensure your .env has RESEND_API_KEY set
--
-- 4. Test password reset flow:
--    - Request password reset
--    - Check email_logs table for delivery status
--    - Verify token in password_reset_tokens table
--    - Complete reset and verify token is marked as used
-- ============================================================================
